...
#pragma endregion city
#pragma region family house
...
#pragma endregion family house
#pragma region quest giver
	//Insercoes no qg
...
#pragma endregion inn
#pragma region mausoleum
...
#pragma region forest
	...
	forest->insertEntity(new InvestigateNpc(59 * 32, 7 * 32, 32, 32, 1, "Dercy Gon?alves, famous for acting in the movie The Mummy, 1500 A.C. - 2008 D.C."));
	forest->insertEntity(new InvestigateNpc(57 * 32, 7 * 32, 32, 32, 1, "Galv?o Bueno, endangered bird, 1500-2010"));
...
#pragma region multi-player state
...
#pragma endregion multi-player state

			//process input
			Entity::doControl();
			//update mc position
			myscreen.updatePosition(*heroi);
			//process warps and events
#pragma region warps
